...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['vs Bigger Cheese'],
			['xx01xx02',			'xx01xx02',			'Creator guy',												'https://twitter.com/xx01xx02istaken',	'696969'],
			['ZerroTheWolf',		'youtub',			'person who uploaded the song\nused for party',				'https://www.youtube.com/watch?v=vdVnnMOTe3Q',	'696969'],
			[''],
			['Psych Engine Team'],
